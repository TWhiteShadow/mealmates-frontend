...
export default function ProductPage() {
  ...
  const isExpiringSoon =
    !product.soldAt && dayjs(product.expiryDate).diff(dayjs(), 'day') <= 1;
  ...
  return (
    <div className='min-h-screen bg-gray-50 pb-20'>
          ...
          <div className='mt-10 px-4 sm:px-0 sm:mt-16 lg:mt-0'>
            <div className='flex flex-col-reverse gap-4 lg:flex-col'>
              <div className='flex justify-between items-start'>
                <div>
                  ...
                  <UserCardLink user={product.seller}>
                ...
                <p className='text-3xl font-bold text-purple-semi-dark'>
                  {formattedPrice == '0,00 €' ? 'Don' : formattedPrice}
                </p>
              </div>
              {product.soldAt && (
                <div className='text-sm text-gray-500'>
                  <span className='font-semibold text-green-600 text-xl'>
                    Ce produit à été vendu le{' '}
                    {dayjs(product.soldAt).format('DD MMMM YYYY')} à{' '}
                    {product.buyer?.first_name + ' ' + product.buyer?.last_name}
                  </span>
                </div>
              )}
            </div>
            ...
            <div className='mt-6 space-y-6'>
              ...
              {product.food_preferences &&
                product.food_preferences.length > 0 && (
                  <div>
                    <div className='text-sm font-medium text-gray-900'>
                ...
                <div>
                  ...
                  <div className='mt-2 flex flex-wrap gap-2'>
                    {product.allergens.map((allergen) => (
                      <span
                        key={
                          typeof allergen === 'object' ? allergen.id : allergen
                        }
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            Cette action est irréversible. L'offre sera
      ...
      <ReportDialog
        ...
        description='Pourquoi souhaitez-vous signaler cette offre ?'
        options={[
          { value: 'fraud', label: 'Arnaque ou fraude' },
          { value: 'inappropriate', label: 'Contenu inapproprié' },
          { value: 'expired', label: 'Produit expiré' },
          { value: 'misrepresentation', label: 'Description trompeuse' },
